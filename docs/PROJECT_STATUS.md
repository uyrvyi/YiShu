...
- ESLint：PASS
- Prettier：PASS
- Vitest：233 passed / 0 failed（shared 11 / config 19 / db 2 / simulation 11 / routing 19 / worker 1 / mobile 26 / api 144；其中 world-events 33/33，关键 replay fixture 连续 3 轮稳定）
